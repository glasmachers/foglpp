...
namespace fogl {
  ...
  template<GLenum type, GLenum binding> struct buffer_cref : cref {
    /// Bind the buffer.
    void bind() const {
  ...
  template<GLenum type, GLenum binding> struct buffer_ref : buffer_cref<type, binding> {
    using buffer_cref<type, binding>::id;
    ...
    /// Create from a given id.
    buffer_ref(from_id, GLuint id) : buffer_cref<type, binding>(from_id(), id) {
    }
    /// Create without checking whether the id is valid.
    buffer_ref(no_validity_check, GLuint id) : buffer_cref<type, binding>(no_validity_check(), id) {
    }
    /// Create without checking whether the id is valid.
    buffer_ref(undefined) : buffer_cref<type, binding>(undefined()) {
    }
  };

  /// C++ wrapper of a pointer to a constant opengl buffer.
  template<GLenum type, GLenum binding> using buffer_cptr = cptr<buffer_ref<type, binding>, buffer_cref<type, binding>>;
  /// C++ wrapper of a pointer to a mutable opengl buffer.
  template<GLenum type, GLenum binding> using buffer_ptr = ptr<buffer_ref<type, binding>, buffer_cref<type, binding>>;

  /// C++ wrapper of an opengl buffer.
  template<GLenum type, GLenum binding> struct buffer : obj<buffer<type, binding>, buffer_ref<type, binding>, buffer_cref<type, binding>> {
    using obj<buffer<type, binding>, buffer_ref<type, binding>, buffer_cref<type, binding>>::id;
    /// Destroy the buffer.
    void destroy() {
      if (!*this)
        return;
    ...
    buffer(from_id, GLuint id) : obj<buffer<type, binding>, buffer_ref<type, binding>, buffer_cref<type, binding>>(from_id(), id) {
    }
  ...
  using array_buffer_cref = buffer_cref<GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING>;
  /// C++ wrapper of a reference to a mutable opengl array buffer.
  using array_buffer_ref = buffer_ref<GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING>;
  /// C++ wrapper of a pointer to a constant opengl array buffer.
  using array_buffer_cptr = buffer_cptr<GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING>;
  /// C++ wrapper of a pointer to a mutable opengl array buffer.
  using array_buffer_ptr = buffer_ptr<GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING>;
  /// C++ wrapper of an opengl array buffer.
  using array_buffer = buffer<GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING>;

  /// C++ wrapper of a reference to a constant opengl element array buffer.
  using element_array_buffer_cref = buffer_cref<GL_ELEMENT_ARRAY_BUFFER, GL_ELEMENT_ARRAY_BUFFER_BINDING>;
  /// C++ wrapper of a reference to a mutable opengl element array buffer.
  using element_array_buffer_ref = buffer_ref<GL_ELEMENT_ARRAY_BUFFER, GL_ELEMENT_ARRAY_BUFFER_BINDING>;
  /// C++ wrapper of a pointer to a constant opengl element array buffer.
  using element_array_buffer_cptr = buffer_cptr<GL_ELEMENT_ARRAY_BUFFER, GL_ELEMENT_ARRAY_BUFFER_BINDING>;
  /// C++ wrapper of a pointer to a mutable opengl element array buffer.
  using element_array_buffer_ptr = buffer_ptr<GL_ELEMENT_ARRAY_BUFFER, GL_ELEMENT_ARRAY_BUFFER_BINDING>;
  /// C++ wrapper of an opengl element array buffer.
  using element_array_buffer = buffer<GL_ELEMENT_ARRAY_BUFFER, GL_ELEMENT_ARRAY_BUFFER_BINDING>;
